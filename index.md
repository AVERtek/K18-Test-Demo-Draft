...
<model-viewer src="Models/K18_TEST_Ver4.glb?sound=Sound/K18_Test_2_sound.mp3" camera-controls camera-orbit="0deg 90deg 30%" autoplay animation-name="" id="reveal" id="model-viewer" loading="eager" ar ar-modes="scene-viewer webxr quick-look" ios-src="Models/DodgerGuy.reality" alt="K18 Fiber Journey" auto-rotate-delay="0" ar-scale="auto" camera-controls alt="K18-Test-Demo-Draft" style="width: 95%; height: 650px" ><button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; ">
...
<br><br>
<h2 style="text-align: center;" markdown="1"><b>LEARN MORE:</b><a href="https://youtu.be/fZyuT3tbEGE" onclick="getOutboundLink('https://youtu.be/fZyuT3tbEGE'); return false;"><b> HERE</b></h2> 
<br><br>
<h2 style="text-align: center;" markdown="1"><b>UNDERSTANDING THE SCIENCE:</b><a href="https://www.k18hair.com/pages/our-science" onclick="getOutboundLink('https://www.k18hair.com/pages/our-science'); return false;"><b> CLICK HERE</b></h2> 
<br><br>
<br><br>
